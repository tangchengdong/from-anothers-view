...
const CARD_IMAGES = {
  'libai': 'card_01_李白(1).webp',
  'waixingren': 'card_02_外星观察者(1).webp',
  'weilaiai': 'card_03_未来AI(1).webp',
  'jiqimao': 'card_04_蓝色机器猫(1).webp',
  'gudaihuangdi': 'card_05_古代皇帝(1).webp',
  'zhandijizhe': 'card_06_战地记者(1).webp',
  'wuxiajianke': 'card_07_古代侠客(1).webp',
  'yuhangyuan': 'card_08_宇航员(1).webp',
  '00daxuesheng': 'card_09_00后大学生(1).webp',
  'xiaopengyou': 'card_10_幼儿园小朋友(1).webp',
  'liuliangmao': 'card_11_流浪猫(1).webp',
  'senlinglieren': 'card_12_森林猎人(1).webp',
  'gudaiyisheng': 'card_13_古代医者(1).webp',
  'gudongshoucang': 'card_14_古董收藏家(1).webp',
  'guangchangdama': 'card_15_退休广场舞大妈(1).webp',
  'waimai': 'card_16_外卖骑手(1).webp',
  'chengxuyuan': 'card_17_资深程序员(1).webp',
  'meishi': 'card_18_美食博主(1).webp',
  'wanghong': 'card_19_网红主播(1).webp',
  'jianshen': 'card_20_健身教练(1).webp',
  'xiaofan': 'card_21_菜市场小贩(1).webp',
